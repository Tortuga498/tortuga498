...
class ObjectSearch:
  def __init__(self):
    ...
    for name in self.trainImageNames:
      ...
      self.trainImg.append(img) # total 3
  ...
  def findMatch(self):
    for img in self.trainImg:
      ...
      kp1, des1 = sift.detectAndCompute(self.image, None)  #self.image come from camera
      
      kp2, des2 = sift.detectAndCompute(img, None)# total 3
      ...
      if matchesMask <> None:
        draw_params = dict(matchColor = (0, 255, 0), # draw matches in green color
                           ...
                           flags = 2)
        img1 = cv2.drawMatches(self.image, kp1, img, kp2, good, None, **draw_params) #show from camera 
